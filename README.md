# LearningPlaywright — JavaScript Fundamentals & Automation Learning Repo
...
git clone https://github.com/SandeepPrasad01/LearningPlaywright.git
node 01_Basics/01_Hello.js
```
...
The one exception is `18_Async_Await/151_Example_Spec.js`, a Playwright test. It needs the Playwright toolchain:

```bash
npm init playwright@latest   # once per machine/project
npx playwright install       # downloads browsers
npx playwright test 18_Async_Await/151_Example_Spec.js
```

**How to use this repo:** read a chapter's Concept section → open its lesson files → predict each output before running → verify with `node` → close gaps with the linked IQ notes.
...
LearningPlaywright/
├── 01_Basics/
│   └── 01_Hello.js                          # console.log basics
├── 02_JavaScript_Concepts/
│   └── 02_let_Concept.js                    # let scoping basics
├── 03_Identifier/
│   ├── 03_Identifier_Rules.js               # valid/invalid identifier characters
│   ├── 04_Identifier_Rules2.js              # naming conventions (camelCase, PascalCase, etc.)
...
│   ├── 10_Literal2.js                       # number literal formats (hex, octal, exponent)
│   ├── 11_Number.js                         # integer/float/binary/octal/hex literals
│   └── 12_Number_Part2.js                   # numeric separators, BigInt, Infinity, NaN
├── 05_Operators/
│   ├── 13_Datatypes.js                      # the 7 primitive types + array/NaN
│   ├── 14_Assignment_Operator.js            # =, +=, -=, *=, /=, %=
│   ├── 15_Airthmetic_Operator.js            # + - * / %, ** exponent, odd/even
│   ├── 16_Comparison_Operator.js            # ==, ===, !=, !==, >, <, >=, <=
│   ├── 17_Logical_Operator.js               # && || !  (AND / OR / NOT gates)
│   ├── 18_Confusing_Comparison.js           # "" vs 0 vs "0" coercion, broken transitivity
│   ├── 19_Confusing_Comparison2.js          # null/undefined equality gotchas
│   ├── 20_Questions.js                      # != vs !== practice
│   ├── 21_String_operator.js                # string concat with + and +=, console.log multi-arg
│   ├── 22_Ternary_Operator.js               # condition ? valueIfTrue : valueIfFalse
│   ├── 23_Interview_Ques.js                 # ternary → PASS/FAIL assertion result
│   ├── 24_Interview_Ques2.js                # ternary → env-based baseUrl switch
│   ├── 25_Interview_Ques3.js                # ternary → CI headless vs headed
│   ├── 26_Interview_Ques4.js                # ternary → SLA check + template literals
│   ├── 27_Interview_Ques5.js                # ternary returning booleans (anti-pattern)
│   ├── 28_Nested_Ternary_Oper.js            # nested ternary — age → drink check
│   ├── 29_Interview_Ques_NT.js              # nested ternary — HTTP status category
│   ├── 30_Interview_Ques2_NT.js             # nested ternary — temperature bands
│   ├── 31_Type_Operator.js                  # typeof on string/number/array/null
│   ├── 32_Inc_Dec_Operator.js               # pre vs post increment (++a vs a++)
│   ├── 33_Add_Increment.js                  # increment inside an expression
│   ├── 34_Increment2.js                     # post-increment return value vs variable
│   ├── 35_Decrement.js                      # pre vs post decrement (--a vs a--)
│   └── 36_Null_Coalescing.js                # nullish coalescing ?? (null/undefined fallback)
├── 06_Statement/
│   ├── 37_Interview_Question.js             # if / else -> age gate
│   ├── 38_Interview_Question2.js            # nested if -> drink-age check
│   └── 39_Multiple_Condition.js             # else-if ladder -> score to grade
├── 07_Switch/
│   ├── 40_Switch.js                         # basic switch statement and break
│   ├── 41_Interview_Question.js             # deliberate fall-through example
│   ├── 42_Interview_Question2.js            # switch with breaks and default
│   ├── 43_Real_API_Testing.js               # HTTP status-code branching
│   ├── 44_Switch_Group.js                   # grouped browser cases
│   ├── 45_Interview_Ques.js                 # string-case fall-through
│   ├── 46_Interview_Ques2.js                # switch(true) range matching
│   ├── 47_Interview_Ques3.js                # duplicate case behavior
│   └── 48_Interview_Ques4.js                # strict case matching
├── 08_UserInputs/
│   ├── 49_JS.js                             # browser prompt input
│   ├── 50_Node_UI.js                        # Node.js readline input
│   ├── 51_Prompt.js                         # prompt-sync package input
│   └── 52_fs.js                             # stdin input with fs.readFileSync
├── 09_Loops/
│   ├── 53_Loops.js                          # repeated statements without a loop
│   ├── 54_For_loop.js                       # for-loop syntax and execution
│   ├── 55_Increment.js                      # prefix increment review
│   ├── 56_For_loops2.js                     # inclusive for-loop range
│   ├── 57_For_loops3.js                     # conditions inside a for loop
│   ├── 58_While_loop.js                     # equivalent for and while loops
│   ├── 59_While_loop2.js                    # bounded retry loop
│   ├── 60_Sandy.js                          # while-loop repetition
│   ├── 61_While_vs_For.js                   # while(true) with break
│   ├── 62_Do_While.js                       # do-while retry example
│   ├── 63_Do_While_VS_While.js              # first-run behavior comparison
│   └── 64_Nested_For_loop.js                # nested loops and index pairs
├── 10_Arrays/
│   ├── 65_Arrays.js                         # indexing, .at(-1), length, negative index
│   ├── 66_Arrays2.js                        # length, out-of-bounds returns undefined
│   ├── 67_Arrays_Creation.js                # literal, new Array, Array.of, Array.from
│   ├── 68_Arrays_Access_Modify.js           # bracket access, .at(), assign by index
│   ├── 69_Arrays_Adding_Remove.js           # push/pop/unshift/shift/splice
│   ├── 70_Array_Real.js                     # real loop over a browser list
│   ├── 71_Arrays_Searching.js               # indexOf, lastIndexOf, includes
│   ├── 72_Interview_Ques.js                 # find, findIndex, findLast, findLastIndex
│   ├── 73_Arrays_Interate.js                # for, for...of, forEach, entries, for...in
│   ├── 74_Arrays_Transform.js               # map (transform) vs filter (select)
│   ├── 75_Arrays_Sorting.js                 # default lexicographic sort, comparators, reverse
│   ├── 76_Arrays_Slicing.js                 # slice(start, end), negative indexes, no mutation
│   ├── 77_Arrays_Concat.js                  # concat, spread (...), join
│   ├── 78_Arrays_Checking.js                # Array.isArray, every, some, ASI semicolon trap
│   ├── 79_Arrays_Copy.js                    # shallow copy 4 ways vs reference assignment
│   └── 80_Arrays_Destructuring.js           # array destructuring, rest, defaults, swap
├── 11_Functions/
│   ├── 81_Fn.js                             # why functions exist — kill repeated logic
│   ├── 82_Fn2.js                            # define once, call many times
│   ├── 83_Type1_Basic_Fn.js                 # Type 1 — no param, no return (undefined)
│   ├── 84_Type2_Basic_Fn.js                 # Type 2 — params, no return
│   ├── 85_Type3_Basic_Fn.js                 # Type 3 — no params, returns a value
│   ├── 86_Type4_Basic_Fn.js                 # Type 4 — params + return
│   ├── 87_Template_Literals.js              # returning a template literal
│   ├── 88_Fn_Expression.js                  # function declaration vs function expression
│   ├── 89_Arrow_Fn.js                       # declaration → expression → arrow, same output
│   ├── 90_Arrow_Fn2.js                      # implicit vs block-bodied arrows
│   ├── 91_Real.js                           # same status-code check in all three styles
│   ├── 92_IIFE_Fn.js                        # IIFE — anonymous and arrow form
│   ├── 93_Spread_Fn.js                      # spread args in, rest params collect
│   ├── 94_Return_Fn.js                      # if/else-if/else returns, no return → undefined
│   ├── 95_Var_Let_Const.js                  # var function-scope vs let block-scope vs const
│   ├── 96_Hoisting.js                       # memory-creation vs execution phase
│   ├── 97_Var_Hoisting.js                   # var hoisted as undefined
│   ├── 98_Fn_Hoisting.js                    # var hoisting inside a function scope
│   ├── 99_Let_Hoisting.js                   # let hoisted but uninitialized → ReferenceError
│   ├── 100_TDZ.js                           # var leaks out of the if block
│   ├── 101_TDZ2.js                          # Temporal Dead Zone in a block
│   ├── 102_IQ.js                            # let shadowing + TDZ trap
│   ├── 103_IQ2.js                           # declaration hoists, expression does not
│   ├── 104_IQ3.js                           # const for URLs and config, no reassignment
│   ├── 105_Hoisting_TDZ.md                  # full hoisting + TDZ reference guide
│   └── 106_IQ4.js                           # TDZ shadowing trap
├── 12_FN_Closure/
│   ├── 106_Scope_Fn.js                      # global vs local scope, inner sees outer
│   ├── 107_Closure.js                       # returned function remembers its birthplace
│   ├── 108_Closure_Remember.js              # counter with private state (increment/get)
│   ├── 109_Fn_Closure_Real.js               # max-retry tracker per test
│   └── 110_Fn_Simple.js                     # rate limiter returning true/false
├── 13_String/
│   ├── 111_String.js                        # quotes, template literals, multiline, String()
│   ├── 112_String_Fn.js                     # length, index, .at(), charAt, charCodeAt
│   ├── 113_Str_Searching.js                 # includes, startsWith/endsWith, indexOf
│   ├── 114_Extraction_String.js             # slice, substring, negative indexes, .at()
│   ├── 115_String_More.js                   # case, trim, replace, concat
│   ├── 116_Extra.js                         # regex replacement, split, join
│   ├── 117_Fn_String_Conversion.js          # String/Number conversion and immutability
│   └── String_Cheatsheet.md                 # complete SDET-focused string reference
├── 14_Objects/
│   ├── 118_Objects.js                       # literals, key access, reference equality
│   ├── 119_Object_Person.js                 # deeply nested object with methods
│   ├── 120_Object2.js                       # object method and this
│   ├── 121_Object3.js                       # access, add, and update properties
│   ├── 122_Config.js                        # dynamic config properties and delete
│   └── 123_CallByRef_CallByValue.js         # primitive copies vs object references
├── 15_Multi_Dimensional_Arrays/
│   ├── 124_1D_Array.js                      # 1D vs 2D arrays, nested-loop grid print
│   ├── 125_MD_Arrays.js                     # more 2D array examples
│   ├── 126_MD_Arrays_Fn.js                  # map/reduce over rows, real suite results
│   ├── 127_Right_Pattern.js                 # right-triangle star pattern
│   ├── 128_Left_Hand.js                     # inverted (left-hand) star pattern
│   └── 129_Pyramid_Pattern.js               # centered pyramid pattern
├── 16_Callback/
│   ├── 130_Callback.js                      # callback as arg — 3 ways to pass (named/anon/arrow)
│   ├── 131_Callback2.js                     # async test callback signature
│   ├── 132_Sync_Callback.js                 # synchronous forEach callback
│   ├── 133_Async_Callback.js                # setTimeout — async callback ordering
│   ├── 134_Callback_Hell.js                 # nested login-flow callbacks (the "hell")
│   ├── 135_Call_RealHello.js                # deep nested error-first callback chain
│   ├── 136_Call_Return.js                   # callback returning a value
│   └── 137_Pyramid_DOM.js                   # nested DOM-step callback pyramid
├── 17_Promise/
│   ├── 138_Promise.js                       # new Promise, resolve/reject states
│   ├── 139_Real_Promise_API.js              # .then on a resolved promise
│   ├── 140_Real_Promise_API2.js             # .catch on a rejected promise
│   ├── 141_Promise_Finally.js               # .finally always runs
│   ├── 142_Promise_Real.js                  # promise chaining for a login flow
│   ├── 143_Promise_All.js                   # Promise.all — all-or-fail
│   ├── 144_Promise_Settle.js                # Promise.allSettled — report every test
│   ├── 145_Promise_Race.js                  # Promise.race — first to settle wins
│   ├── 146_Promise_IQ.js                    # promise state quiz questions
│   └── 147_Promise_IQ2.js                   # all/allSettled quiz questions
├── 18_Async_Await/
│   ├── 148_Async _Await_Intro.js            # .then chain vs async/await shape
│   ├── 149_Better_Way.js                    # async/await login and API request flows
│   ├── 150_AA.js                            # async return values and awaiting resolved promises
│   ├── 151_Example_Spec.js                  # await inside a Playwright test
│   ├── 152_ErrorHandling_Catch.js           # try/catch/finally error handling
│   ├── 153_Seq_Execution.js                 # dependent API calls run sequentially
│   ├── 154_Parallel_Execution.js            # independent API calls with Promise.all
│   ├── 155_API_Flaky.js                     # bounded retry-until-success pattern
│   └── 156_IQ.js                            # async/await interview examples and execution order
├── 19_Import_Export/
│   ├── util.js                              # named exports: BASE_URL, formatTestName, formatTestName2
│   ├── testutil.js                          # named exports: BASE_URL, formatUpperCaseString
│   ├── Logs/
│   │   └── Logger.js                        # default export (log) + named export (logBetter)
│   ├── 157_Import.js                        # importing named exports from testutil.js
│   ├── 158_Test.js                          # importing from two modules with alias renaming
│   └── 159_Import2.js                       # default import from Logs/Logger.js
...
│   └── 03_Static/                           # static fields, methods, and instance fields
├── 21_OOPs_Encapsulation/
│   ├── 171_Encp_Child.js                    # private fields with getter and setter methods
│   ├── 172_Encp_Car.js                      # encapsulated car engine example
│   ├── 173_Encp_Bank.js                     # protected balance update example
│   └── 174_IQ.js–177_IQ4.js                 # automation and interview practice
├── 22_OOPs_Inheritance/
│   └── Single_Inheritance/
│       ├── 178_SI.js–181_IQ2.js             # extends, super, overriding, setup, and teardown
│       └── 182_IQ3.js–184_Report.js         # polymorphic test, page, and report examples
└── IQ_Notes/
    ├── let_var_const_IQ.md                  # let vs var vs const breakdown
    ├── sourcecode_bytecode_binarycode_IQ.md  # source vs bytecode vs machine code
    ...
    └── 04_Commands_Win.md                    # VS Code shortcuts — Windows
```
...
```js
console.log("Hello Sandeep, Welcome to the world of JavaScript.");
```
...
**Concept:** `let` declares a block-scoped variable. Unlike `var` (function-scoped), a `let` binding only exists inside its enclosing block, and unlike `const` it can be reassigned.
...
**Q&A — why use this?**
- **Q: Why use `let` over `var`?** A: `let` is block-scoped and cannot be re-declared in the same scope, which prevents the leak and clobbering bugs `var` is known for.
- **Q: When would I use `const` instead?** A: When the binding is never reassigned — the default choice in modern code.
- **Q: What does `console.log(x)` print?** A: `6` — the value assigned on the line above.
...
```bash
node 02_JavaScript_Concepts/02_let_Concept.js
```
...
See [`08_UserInputs/`](08_UserInputs/) for all four input methods — `prompt` (browser), `readline` (Node), `prompt-sync` (package), and `fs` (stdin) — with their run commands in `49_JS.js`, `50_Node_UI.js`, `51_Prompt.js`, and `52_fs.js`.
...
**Practice:** revisit [`10_Arrays/`](10_Arrays/) and run each lesson to test yourself before moving to functions.
...
Full walkthrough with class hoisting, interview traps, and phase diagrams: [`11_Functions/105_Hoisting_TDZ.md`](11_Functions/105_Hoisting_TDZ.md).

**Reference:** how source code becomes machine code — [`IQ_Notes/sourcecode_bytecode_binarycode_IQ.md`](IQ_Notes/sourcecode_bytecode_binarycode_IQ.md).
...
| Lesson | Focus |
|--------|-------|
| [`148_Async _Await_Intro.js`](18_Async_Await/148_Async%20_Await_Intro.js) | `.then` chain vs async/await shape, and the flow of an async function. |
| [`149_Better_Way.js`](18_Async_Await/149_Better_Way.js) | async/await login and API request flows. |
| [`150_AA.js`](18_Async_Await/150_AA.js) | Async return values and awaiting resolved promises. |
| [`151_Example_Spec.js`](18_Async_Await/151_Example_Spec.js) | Playwright actions and assertions awaited inside an async test. |
| [`152_ErrorHandling_Catch.js`](18_Async_Await/152_ErrorHandling_Catch.js) | Rejected promises handled with `try`, `catch`, and `finally`. |
| [`153_Seq_Execution.js`](18_Async_Await/153_Seq_Execution.js) | Dependent API calls run sequentially. |
| [`154_Parallel_Execution.js`](18_Async_Await/154_Parallel_Execution.js) | Independent API calls with `Promise.all`. |
| [`155_API_Flaky.js`](18_Async_Await/155_API_Flaky.js) | Bounded retry-until-success pattern with async/await. |
| [`156_IQ.js`](18_Async_Await/156_IQ.js) | Interview examples covering resolved values, rejection handling, and execution order. |
...
```bash
node 18_Async_Await/148_Async\ _Await_Intro.js
node 18_Async_Await/149_Better_Way.js
node 18_Async_Await/150_AA.js
node 18_Async_Await/152_ErrorHandling_Catch.js
node 18_Async_Await/153_Seq_Execution.js
node 18_Async_Await/154_Parallel_Execution.js
node 18_Async_Await/155_API_Flaky.js
node 18_Async_Await/156_IQ.js
```

`151_Example_Spec.js` requires a project with `@playwright/test` and its browser installed. From that configured environment, run:
...
- **Q: How do I import a named export?** A: Use curly braces with the exact name: `import { BASE_URL, formatTestName } from './util.js'`. Rename with `as`: `import { BASE_URL as url } from './util.js'`.
...
```mermaid
flowchart TD
    U["util.js"] -->|"export let BASE_URL<br/>export function formatTestName"| N["Named exports"]
    ...
    N --> I1["import { BASE_URL, formatTestName } from './util.js'"]
...
```js
// 157_Import.js — importing named exports
...
// 158_Test.js — importing from two modules, renaming with `as`
...
// 159_Import2.js — default import (no braces, any name)
...
Run the lessons with Node.js. Node detects the `import`/`export` syntax automatically (no `package.json` needed):

```bash
node 19_Import_Export/157_Import.js
node 19_Import_Export/158_Test.js
node 19_Import_Export/159_Import2.js
```
...
Run a lesson from each subfolder:

```bash
node 20_Class_Object_OOPs/01_Class_Object/160_Class.js
node 20_Class_Object_OOPs/02_Public_Private/164_Real.js
node 20_Class_Object_OOPs/03_Static/167_Static.js
```
...
The lessons demonstrate private fields with getter/setter methods, and validation before a private value is changed.

```bash
node 21_OOPs_Encapsulation/171_Encp_Child.js
node 21_OOPs_Encapsulation/172_Encp_Car.js
node 21_OOPs_Encapsulation/173_Encp_Bank.js
```
...
```bash
node 22_OOPs_Inheritance/Single_Inheritance/178_SI.js
node 22_OOPs_Inheritance/Single_Inheritance/179_SI2.js
node 22_OOPs_Inheritance/Single_Inheritance/183_IQ4.js
node 22_OOPs_Inheritance/Single_Inheritance/184_Report.js
```
...
Concept explainers — table breakdown, code walkthrough, pipeline diagram, TL;DR. New notes are added to the [`IQ_Notes/`](IQ_Notes/) folder as they are written.

| File | Covers |
|------|--------|
| [`sourcecode_bytecode_binarycode_IQ.md`](IQ_Notes/sourcecode_bytecode_binarycode_IQ.md) | Source code vs bytecode vs binary/machine code, V8 compilation pipeline |
| [`let_var_const_IQ.md`](IQ_Notes/let_var_const_IQ.md) | `let` vs `var` vs `const` breakdown |
...
| [`04_Commands_Win.md`](IQ_Notes/04_Commands_Win.md) | VS Code keyboard shortcuts — Windows |

---

> **TL;DR:** A from-scratch JavaScript fundamentals course for test automation, plus an IQ_Notes reference library.
...
| 21 | OOP Encapsulation | Private fields, getters/setters, controlled state changes | ✅ |
| 22 | OOP Inheritance | `extends`, `super`, constructor chaining, method overriding | ✅ |
| — | IQ_Notes | Standalone concept references | ✅ |

**Suggested next chapters:** OOP Polymorphism · OOP Abstraction · Playwright fixtures · Page Object Model · API testing with `request` · Network interception